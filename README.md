...
| `deploy`     | 1×          | `deployment` domain (26 lenses) or `android` domain (4 lenses) | Server or Android APK audit — inspects a live server or APK target          |
...
## Domains & Lenses (301 total across 31 domains)
...
| **Android**               | `deploy`     | 4 lenses  | APK overview, package metadata, AndroidManifest permissions and component flags, APK secrets, credentials, internal URLs, WebView security settings, JavaScript bridges, and device-aware Android audit context                                    |
